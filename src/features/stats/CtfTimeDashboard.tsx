...
// TODO: Uncomment and update this when Cloudflare proxy is ready
// const PROXY_URL = 'https://your-proxy-name.your-subdomain.workers.dev';

export const CtfTimeDashboard: React.FC = () => {
  // TODO: Uncomment this when Cloudflare proxy is ready
  ...
  // Fallback state - showing static info for now
  return (
